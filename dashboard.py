...
# Set Page Config
logo_path = "sigap_cropped.png"
try:
    st.set_page_config(page_title="Dashboard Analisis Kemiskinan", page_icon="sigap .png", layout="wide")
except Exception:
...
sigap_base64 = get_base64_image(logo_path)
logo_html = f'<img src="data:image/png;base64,{sigap_base64}" style="height: 85px; margin-right: 25px;">' if sigap_base64 else '<span style="font-size: 40px; margin-right: 15px;">📊</span>'
...
st.markdown("""
    ...
    .top-banner {
        ...
        margin-bottom: 20px;
        margin-top: -30px;
        box-shadow: 0 6px 20px rgba(255, 174, 79, 0.4);
    }
    .banner-title {
        display: flex;
        align-items: center;
...
<div class="top-banner">
    <div class="banner-title">
        {logo_html}
        <span style="color: #2b2b36; font-weight: 900; font-size: 35px; letter-spacing: 0.5px;">Dashboard Analisis Spasial Kemiskinan</span>
    </div>
    <div class="cards-row">
