...
<div class="top-banner">
    <div class="banner-title" style="display: flex; align-items: center;">
        <img src="data:image/png;base64,{sigap_base64}" style="height: 65px; transform: scale(2.8); transform-origin: center left; margin-left: 30px; margin-right: 120px; object-fit: contain;" alt="Logo Sigap">
