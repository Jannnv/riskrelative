...
logo_path = "sigap .png"
try:
    st.set_page_config(page_title="Dashboard Analisis Kemiskinan", page_icon=logo_path, layout="wide")
except Exception:
...
logo_html = f'<img src="data:image/png;base64,{sigap_base64}" style="height: 50px; margin-right: 15px;">' if sigap_base64 else '<span style="font-size: 40px; margin-right: 15px;">📊</span>'
...
<div class="top-banner">
    <div class="banner-title">
        {logo_html}
        <span style="color: white; font-weight: bold; font-size: 32px; letter-spacing: 0.5px;">Dashboard Analisis Spasial Kemiskinan</span>
    </div>
    <div class="cards-row">
