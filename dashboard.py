...
<div class="top-banner">
    <div class="banner-title">
        <img src="data:image/png;base64,{sigap_base64}" style="height: 190px; margin-right: 25px; padding-right: 25px; border-right: 3px solid rgba(255, 255, 255, 0.7); object-fit: contain;" alt="Logo Sigap">
